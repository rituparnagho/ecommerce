...
const Banner = () => {
  ...
  >
      ...
      <SwiperSlide>
        <img src="https://prod.aaw.com/media/weltpixel/owlcarouselslider/images/d/e/dec4_homepage_desktop.jpg" className="swiper-image" alt=""/>
      </SwiperSlide>
      <SwiperSlide>
        <img src="https://prod.aaw.com/media/weltpixel/owlcarouselslider/images/1/8/1800-x-600.gif" className="swiper-image" alt="" />
      </SwiperSlide>
      </div>
      {/* <SwiperSlide>
